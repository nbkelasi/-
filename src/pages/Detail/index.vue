          ...
          <div class="choose">
            ...
            <div class="chooseArea">
              ...
              <dl v-for="(spu,index) in spuSaleAttrList" :key="spu.id">
                ...
                @click="changeActive(spuSaleAttrValueList,spu.spuSaleAttrValueList)"
                v-for="(spuSaleAttrValueList,index) in spu.spuSaleAttrValueList" 
                :key="spuSaleAttrValueList.Id">{{spuSaleAttrValueList.saleAttrValueName}}</dd>
              </dl>
            </div>
            <!-- 产品数量选择区域 -->
            <div class="cartWrap">
